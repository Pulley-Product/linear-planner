        ...
        {showAlgo && (
          <div style={{
            ...
            <ul style={{ margin: '0 0 12px', paddingLeft: 20, lineHeight: 1.8 }}>
              <li>It figures out the <strong>earliest cycle</strong> the issue can start — taking into account project dependencies ("project B can't start until project A finishes") and issue dependencies ("this issue can't start before that issue finishes"). Issue deps allow the dependent to share the same cycle as its blocker, so spare capacity within a cycle still gets used; capacity, not cycle boundaries, is the real constraint. New work is never placed before your selected start cycle.</li>
